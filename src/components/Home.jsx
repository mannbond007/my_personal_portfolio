    ...
    >
      ...
      <div className="relative z-10 max-w-6xl w-full grid md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-white text-center md:text-left">
          ...
          <p className="max-w-xl text-gray-400 mb-8 lg:text-lg font-Playfair text-[18px] sm:text-2xl-[20px] sm:text-base leading-7">
            Crafting elegant and scalable web solutions with modern
            technologies. Passionate about clean code, great design, and
            seamless user experiences. I specialize in building responsive
            frontends and robust backends, ensuring performance, security, and
            accessibility. Always exploring new tools and frameworks to stay
