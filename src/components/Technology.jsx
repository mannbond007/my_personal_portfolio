...
const Technology = () => {
  return (
    <div
      id="technology"
      className="relative py-32 px-4 bg-slate-950 overflow-hidden"
    >
      {/* Background Grid */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
        ...
        {/* Animated Icons Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 sm:gap-8 max-w-6xl w-full justify-items-center">
